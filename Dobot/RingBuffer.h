...
** Returned value:      None
*********************************************************************************************************/
extern bool RingBufferIsEmpty(RingBuffer *ringBuffer);
...
** Returned value:      None
*********************************************************************************************************/
extern bool RingBufferIsFull(RingBuffer *ringBuffer);
...
** Returned value:      None
*********************************************************************************************************/
extern uint32_t RingBufferGetCount(RingBuffer *ringBuffer);
...
** Returned value:      None
*********************************************************************************************************/
extern uint32_t RingBufferGetLeft(RingBuffer *ringBuffer);

void *RingBufferDataAt(RingBuffer *ringBuffer, uint32_t index);
